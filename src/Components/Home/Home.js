...
class Home extends React.Component {
      ...
      <div className="home">
        ...
        <div className="main-container">
          ...
          <div className="row mt-4 mb-4">
            <div className="col-md-6">
              <Devices alldevices  = {this.state.alldevices} history={this.props.history} lng={lng}/>
            </div>
            <div className="col-md-6" >
  ...
  const mapStateToProps =  state => ({notification: state.notification, language:state.language, systemmessage: state.systemmessage, auth:state.auth})
